...
import { styles } from "./ChangeDisplayProgProgramado.styles";
import Toast from "react-native-toast-message";

export function ChangeDisplayProgProgramado(props) {
        ...
        <Button
          ...
          onPress={() => {
            if (isNaN(text)) {
              ...
              formik.setFieldValue("ProgProgramado", text.toString());
